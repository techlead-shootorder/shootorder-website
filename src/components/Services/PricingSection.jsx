      ...
      <div className="!max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            Transparent Plans. ROI-Driven Execution. Whether you're a Start-up or an Enterprise, 
            scale your digital marketing with the flexibility you need, without long-term contracts.
          </p>
        </div>
          ...
          {pricingData.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-4">
                  <p className="text-2xl font-bold text-[#9a0c28] mb-2">
                    {service.price}
                  </p>
