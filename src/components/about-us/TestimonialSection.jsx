      ...
      <div className="relative !max-w-7xl mx-auto grid grid-cols-2 py-16 px-4 md:px-16 ">
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          <p className="text-base text-gray-800">
            We love our work, yes that&apos;s the simplest way to describe why
            we have been thriving in our business, and serving our global
            clientele without a glitch or sense of dissatisfaction in our
            services.
          </p>
