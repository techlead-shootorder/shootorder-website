...
export const metadata = {
  title:
    "Top 3% Digital Growth Partner in USA, #1 in Connecticut  - ShootOrder®",
  description:
    "ShootOrder is one of the globally awarded Digital Growth Partner , USA. We are amongst the top ranked digital marketing companies with 300+ clients across the globe driving best results in digital marketing services like SEO, PPC, Content Marketing & Social Media.",
  icons: {
